  ...
  const fetchSiteSettings = async () => {
    try {
      ...
      const settings: SiteSettings = {
        ...
        facebook_url: data.find(s => s.id === 'facebook_url')?.value || 'https://www.facebook.com/TeamaxManghinao',
        facebook_handle: data.find(s => s.id === 'facebook_handle')?.value || 'TeamaxManghinao',
